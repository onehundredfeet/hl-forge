...
// 2022-07-16 00:03:25.911464
// "shaders/generateMips.comp.fsl"
//--------------------------------------
...
#line 1 "shaders/generateMips.comp.fsl"
/*
...
#define Source_615
	...
	// Metal Resource Declaration: RES(RWTex2D(float4), Source, UPDATE_FREQ_PER_DRAW, u0, binding = 1);

#define _Get_Source Source
	// End of Resource Declaration: Source
#line 25
#define Destination_630

	// Metal Resource Declaration: RES(RWTex2D(float4), Destination, UPDATE_FREQ_PER_DRAW, u1, binding = 2);

#define _Get_Destination Destination
	// End of Resource Declaration: Destination
#line 26

#define RootConstant_646
#line 28
PUSH_CONSTANT(RootConstant, b0)
{
#define MipSize_652
#define _Get_MipSize RootConstant.MipSize
#line 30
...
#ifdef Source_615
	,RWTex2D(float4) Source [[texture(0)]] // main arg
#endif
#ifdef Destination_630
	,RWTex2D(float4) Destination [[texture(1)]] // main arg
#endif
#ifdef RootConstant_646
	,constant struct RootConstant& RootConstant [[buffer(UPDATE_FREQ_USER)]]
#endif
)
#line 34
{    
